...
// /*AFLA*/ #error "Please don't include <linux/compiler-gcc.h> directly, include <linux/compiler.h> instead."
// /*AFLA*/ #endif
// /*AFLA*/ 
// /*AFLA*/ /*
// /*AFLA*/  * Common definitions for all gcc versions go here.
// /*AFLA*/  */
// /*AFLA*/ #define GCC_VERSION (__GNUC__ * 10000		\
// /*AFLA*/ 		     + __GNUC_MINOR__ * 100	\
// /*AFLA*/ 		     + __GNUC_PATCHLEVEL__)
// /*AFLA*/ 
// /*AFLA*/ /* Optimization barrier */
// /*AFLA*/ 
// /*AFLA*/ /* The "volatile" is due to gcc bugs */
// /*AFLA*/ #define barrier() __asm__ __volatile__("": : :"memory")
// /*AFLA*/ /*
// /*AFLA*/  * This version is i.e. to prevent dead stores elimination on @ptr
// /*AFLA*/  * where gcc and llvm may behave differently when otherwise using
// /*AFLA*/  * normal barrier(): while gcc behavior gets along with a normal
// /*AFLA*/  * barrier(), llvm needs an explicit input variable to be assumed
// /*AFLA*/  * clobbered. The issue is as follows: while the inline asm might
// /*AFLA*/  * access any memory it wants, the compiler could have fit all of
// /*AFLA*/  * @ptr into memory registers instead, and since @ptr never escaped
// /*AFLA*/  * from that, it proofed that the inline asm wasn't touching any of
// /*AFLA*/  * it. This version works well with both compilers, i.e. we're telling
// /*AFLA*/  * the compiler that the inline asm absolutely may see the contents
// /*AFLA*/  * of @ptr. See also: https://llvm.org/bugs/show_bug.cgi?id=15495
// /*AFLA*/  */
// /*AFLA*/ #define barrier_data(ptr) __asm__ __volatile__("": :"r"(ptr) :"memory")
// /*AFLA*/ 
// /*AFLA*/ /*
// /*AFLA*/  * This macro obfuscates arithmetic on a variable address so that gcc
// /*AFLA*/  * shouldn't recognize the original var, and make assumptions about it.
// /*AFLA*/  *
// /*AFLA*/  * This is needed because the C standard makes it undefined to do
// /*AFLA*/  * pointer arithmetic on "objects" outside their boundaries and the
// /*AFLA*/  * gcc optimizers assume this is the case. In particular they
// /*AFLA*/  * assume such arithmetic does not wrap.
// /*AFLA*/  *
// /*AFLA*/  * A miscompilation has been observed because of this on PPC.
// /*AFLA*/  * To work around it we hide the relationship of the pointer and the object
// /*AFLA*/  * using this macro.
// /*AFLA*/  *
// /*AFLA*/  * Versions of the ppc64 compiler before 4.1 had a bug where use of
// /*AFLA*/  * RELOC_HIDE could trash r30. The bug can be worked around by changing
// /*AFLA*/  * the inline assembly constraint from =g to =r, in this particular
// /*AFLA*/  * case either is valid.
// /*AFLA*/  */
// /*AFLA*/ #define RELOC_HIDE(ptr, off)						\
// /*AFLA*/ ({									\
// /*AFLA*/ 	unsigned long __ptr;						\
// /*AFLA*/ 	__asm__ ("" : "=r"(__ptr) : "0"(ptr));				\
// /*AFLA*/ 	(typeof(ptr)) (__ptr + (off));					\
// /*AFLA*/ })
// /*AFLA*/ 
// /*AFLA*/ /* Make the optimizer believe the variable can be manipulated arbitrarily. */
// /*AFLA*/ #define OPTIMIZER_HIDE_VAR(var)						\
// /*AFLA*/ 	__asm__ ("" : "=r" (var) : "0" (var))
// /*AFLA*/ 
// /*AFLA*/ #ifdef __CHECKER__
// /*AFLA*/ #define __must_be_array(a)	0
// /*AFLA*/ #else
// /*AFLA*/ /* &a[0] degrades to a pointer: a different type from an array */
// /*AFLA*/ #define __must_be_array(a)	BUILD_BUG_ON_ZERO(__same_type((a), &(a)[0]))
// /*AFLA*/ #endif
// /*AFLA*/ 
// /*AFLA*/ /*
// /*AFLA*/  * Force always-inline if the user requests it so via the .config,
// /*AFLA*/  * or if gcc is too old:
// /*AFLA*/  */
// /*AFLA*/ #if !defined(CONFIG_ARCH_SUPPORTS_OPTIMIZED_INLINING) ||		\
// /*AFLA*/     !defined(CONFIG_OPTIMIZE_INLINING) || (__GNUC__ < 4)
// /*AFLA*/ #define inline		inline		__attribute__((always_inline)) notrace
// /*AFLA*/ #define __inline__	__inline__	__attribute__((always_inline)) notrace
// /*AFLA*/ #define __inline	__inline	__attribute__((always_inline)) notrace
// /*AFLA*/ #else
// /*AFLA*/ /* A lot of inline functions can cause havoc with function tracing */
// /*AFLA*/ #define inline		inline		notrace
// /*AFLA*/ #define __inline__	__inline__	notrace
// /*AFLA*/ #define __inline	__inline	notrace
// /*AFLA*/ #endif
// /*AFLA*/ 
// /*AFLA*/ #define __always_inline	inline __attribute__((always_inline))
// /*AFLA*/ #define  noinline	__attribute__((noinline))
// /*AFLA*/ 
// /*AFLA*/ #define __deprecated	__attribute__((deprecated))
// /*AFLA*/ #define __packed	__attribute__((packed))
// /*AFLA*/ #define __weak		__attribute__((weak))
// /*AFLA*/ #define __alias(symbol)	__attribute__((alias(#symbol)))
// /*AFLA*/ 
// /*AFLA*/ /*
// /*AFLA*/  * it doesn't make sense on ARM (currently the only user of __naked)
// /*AFLA*/  * to trace naked functions because then mcount is called without
// /*AFLA*/  * stack and frame pointer being set up and there is no chance to
// /*AFLA*/  * restore the lr register to the value before mcount was called.
// /*AFLA*/  *
// /*AFLA*/  * The asm() bodies of naked functions often depend on standard calling
// /*AFLA*/  * conventions, therefore they must be noinline and noclone.
// /*AFLA*/  *
// /*AFLA*/  * GCC 4.[56] currently fail to enforce this, so we must do so ourselves.
// /*AFLA*/  * See GCC PR44290.
// /*AFLA*/  */
// /*AFLA*/ #define __naked		__attribute__((naked)) noinline __noclone notrace
// /*AFLA*/ 
// /*AFLA*/ #define __noreturn	__attribute__((noreturn))
// /*AFLA*/ 
// /*AFLA*/ /*
// /*AFLA*/  * From the GCC manual:
// /*AFLA*/  *
// /*AFLA*/  * Many functions have no effects except the return value and their
// /*AFLA*/  * return value depends only on the parameters and/or global
// /*AFLA*/  * variables.  Such a function can be subject to common subexpression
// /*AFLA*/  * elimination and loop optimization just as an arithmetic operator
// /*AFLA*/  * would be.
// /*AFLA*/  * [...]
// /*AFLA*/  */
// /*AFLA*/ #define __pure			__attribute__((pure))
// /*AFLA*/ #define __aligned(x)		__attribute__((aligned(x)))
// /*AFLA*/ #define __printf(a, b)		__attribute__((format(printf, a, b)))
// /*AFLA*/ #define __scanf(a, b)		__attribute__((format(scanf, a, b)))
// /*AFLA*/ #define __attribute_const__	__attribute__((__const__))
// /*AFLA*/ #define __maybe_unused		__attribute__((unused))
// /*AFLA*/ #define __always_unused		__attribute__((unused))
// /*AFLA*/ 
// /*AFLA*/ /* gcc version specific checks */
// /*AFLA*/ 
// /*AFLA*/ #if GCC_VERSION < 30200
// /*AFLA*/ # error Sorry, your compiler is too old - please upgrade it.
// /*AFLA*/ #endif
// /*AFLA*/ 
// /*AFLA*/ #if GCC_VERSION < 30300
// /*AFLA*/ # define __used			__attribute__((__unused__))
// /*AFLA*/ #else
